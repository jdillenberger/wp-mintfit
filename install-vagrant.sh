#!/usr/bin/env bash
echo 'Installing the wp-mintfit testserver'
...
wp core install --url=192.168.13.37/wordpress --title=wp-mintfit-dev --admin_user=$USER --admin_password=$PASS --admin_email=example@exampe.com --allow-root
